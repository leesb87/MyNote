...
<div class="container">	
	<form name="userRegForm" method="post" action="${requestScope.croot}/userRegProc.do">	
 	...
 	<div class="top_des">
        <h4 class="txt01">회원가입 시작하기</h4>
        <p><b>MY NOTE 에 오신걸 환영합니다.</b></p>
    </div>
   ...
   <div class="join">
           ...
           <div class="ly_cont">
                <div class="ly_tit"><span><label >비밀번호</label></span></div>
                <div class="ly_con">
                    <div>                                                       
...
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
		...
		<div class="btn_area_c"> 
		         ...
		         <%-- <a href="${requestScope.croot}/loginForm.do" id="btnCancel" class="btn btn-secondary btn_Atype b_gray btn-sm"><span>취소  </span></a> --%>
		</div>    
</form>
		<br><br>
 		<div class="container">
