...
//======================================================================================================================================================	
          //-------------------- [키워드 검색 흔적 남기기] -----------------	
	         inputData("[name=keyword]", "${requestScope.adminSearchDTO.keyword}"); 
...
<form name="adminForm" method="post" action="${requestScope.croot}/adminForm.do">
	  ...
	  <div class="jumbotron" style="height: 50px; background-color: rgb(35, 67, 105);">
			  <h4 style="text-align: left;" class="text-white"><b>${sessionScope.admin_id} 님 '관리자모드'로 접속하셨습니다! </b></h4>
	   		<!-- 관리자 모드 안내 방법2 -->
		...
		<div class="jumbotron" style="height:550px; padding-top : 50px;">
		 ...
		 <div class="adminAllCnt txt01" style="text-align: left">[총 회원 수] : ${requestScope.adminAllCnt} 명</div>
					    ...
					    <div class="input-group is-invalid">
						     <div class="form-group my-1" style="text-align: center;">
						      ...
						      <div class="form-group my-1">	
								<input type="text" name="keyword" class="form-control-sm keyword" size="20" placeholder="검색어를 입력해주세요." ></td> 
							  </div>
					    </div>
					    </td>
				    </tr>
				...
				<div class="btn_area_c" style="width: 30%; float:none; margin:0 auto"> 
					...
					&nbsp;
					<button type="button" class="btn btn-light" onClick="searchAll();">모두검색</button>
					&nbsp;
					<button type="reset" class="btn btn-light" onclick="resetAll();">초기화</button>
		        </div>   
		</div>
