	...
	$(document).ready(function(){
		...
		function goDictListForm(){
			...
			<c:forEach items="${sessionScope.dictSearchDTO.search_keyword}" var="search_keyword">  
		    	inputData("[name=dictList] [name=search_keyword]", "${search_keyword}");                                                                                 				         
		    </c:forEach>
			inputData(".selectPageNo", "${sessionScope.dictSearchDTO.selectPageNo}");
			...
			document.dictList.action="${requestScope.croot}/dictList.do";
	...
	<!-- navigation -->
	 <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom"><!-- fixed-top -->
	            ...
	            <li class="nav-item dropdown">
	              ...
	              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
	               ...
	               <div class="dropdown-divider"></div>
					  <a class="dropdown-item" href="javascript:goUserModify();">회원정보관리</a>			
	  ...
	  <div class="alert alert-light alert-dismissible fade show" role="alert">
		...
		<input type="hidden" name="keyword" class="keyword" value="${sessionScope.keyword}"/> 
		<input type="hidden" name="lang_code" class="lang_code" value="${sessionScope.lang_code}"/> 
	...
	<form name="dictListForm" method="post" action="${requestScope.croot}/dictList.do">
			...
			<div class="col-6">
				...
				<div class="input-group is-invalid">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
				     ...
				     &nbsp;
				    <button type="button" class="btn btn-secondary" onclick="goDictListForm();">검색목록보기</button>
		...
		<br><br><br><br>
			<div class="cnt txt01" style="text-align: left">
				[검색어 총 개수]:
				<c:choose>
					<c:when test="${requestScope.dictList_contentAllCnt==0}">
						<span>0</span>
					</c:when>
					<c:otherwise>
						<span>${requestScope.dictList_contentAllCnt}</span>
					</c:otherwise>
				</c:choose>
			</div>	
			<!-- 언어탭 선택 파트  -->		
...
<div class="dictList">
			<!-- 통합검색 -->
			<c:forEach items="${requestScope.dictList_content}" var="dict" varStatus="loopTagStatus" >
			<table class="table table1 dicListTable dictListTable_${loopTagStatus.index} lang_color_${dict.lang_code} Regular shadow table-active" border=0 cellpadding=0 cellspacing=0>
				<tr><td>
					<table class="table dicListTable table-light"><!-- table-bordered -->
					  <tbody>
					    <tr>
					      ...
					      <td class="table_lang" style="text-align: center;  width:10%;">
						      <c:choose>
					      ...
					      <td class="rate_cnt_${loopTagStatus.index}" style="text-align: center; width:15%;">${dict.rate_cnt}&nbsp;&nbsp;&nbsp;
					      	<button type="button" class="btn_R btn btn btn-outline-primary btn-sm" onClick="recommend(${loopTagStatus.index});">추천하기</button>
					    ...
					    <tr>
					      ...
					      <td colspan="7" class="table_refer" style="text-align: left;">${dict.refer}</td>
					      <td colspan="2">
			...
			<c:if test="${(requestScope.dictList_contentAllCnt)==0}">
			...
			<form name="dictContentForm" method="post" action="${requestScope.croot}/dictContentForm.do"> 
				<input type="hidden" name="keyword" value="${param.keyword}">
				<input type="hidden" name="dict_no" value="${requestScope.dict_no}"> 
				<input type="hidden" name="lang_code" value="${requestScope.lang_code}">
				<input type="hidden" name="selectPageNo" class="selectPageNo" value="1">
				<input type="hidden" name="rowCntPerPage" class="rowCntPerPage">
			</form>
     
     
          	<!-- 글 수정/삭제 로 이동하는 form 태그 선언하기-->
