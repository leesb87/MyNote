...
<div class="container">	
		<div class="content_inner">
		   <div class="top_des">
		        <h5 class="txt01"><strong>회원정보 수정하기</strong></h5>
 	...
 	<div class="col-9">
			 <table class="table">
			  <tbody>
			    ...
			    <tr>
			      <th scope="row">
			      	<div class="ly_tit"><span><label >주민등록번호</label><em class="register_optional"><br>(필수사항)</em></span></div>
			      </th>
			      <td>
			      	<div class="ly_con">
	                    <div>
...
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
		<div class="container">
			...
			<div class="btn_area_c col-6" style="width: 30%; float:none; margin:0 auto"> 
					<button type="button" class="btn btn-dark btn_Ctype_p btn_Ctype_p2 btn-sm">회원정보수정
